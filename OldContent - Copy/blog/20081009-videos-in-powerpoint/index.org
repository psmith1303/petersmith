...
#+lastmod: 2008-10-09T11:59:00+12:00
#+categories[]: Tech
#+tags[]: Powerpoint Videos
#+draft: False
...
- To get videos from [[https://www.youtube.com/][YouTube]] you can use the web-page from [[https://www.techcrunch.com/get-youtube-movie/][TechCrunch]]. Save the file as a .flv (you'll convert it in the next step)
...
If you want to convert the file, [[https://zamzar.com/][Zamzar]] is pretty good.

It's interesting that I'm increasingly relying on web services, rather than installing applications. Once upon at time, I would have installed an add-on to [[https://www.mozilla.com/en-US/firefox/][Firefox]] to be able to download the video. Then I would have installed a video converter. But not now. It is often quicker, and more reliable to use web services (if you are sure they are clean and not loaded with viruses/spyware/malware).

There is even a nice [[https://www.ensode.net/pdf-crack.jsf][PDF unlocker]] service for those times you lose the password to a .pdf-file.
