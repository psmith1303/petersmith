...
#+lastmod: 2004-03-09T11:01:00+12:00
#+categories[]: Teaching
#+tags[]: MGMT301 Movabletype
#+draft: False

After talking with [[https://www.thereflectivepractitioner.org/dkolb/][Darl]], I've sent an email out through /Cecil/ to the [[{{< relref "20040308-mgmt-301" >}}][class]] about journaling.
...
Of course there are some downsides. The system I'm using here, [[https://www.movabletype.org/][Movable Type]], is one of the best blogging systems and it can be pretty straight forward to use--but if anyone wants to customise the look (and why shouldn't they) it can take the notice sometime to get to grips with the complexity of the system.
