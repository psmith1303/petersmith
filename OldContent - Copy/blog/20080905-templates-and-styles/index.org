...
#+lastmod: 2008-09-05T15:10:00+12:00
#+categories[]: Tech
#+tags[]: Movabltype Upgrades
#+draft: False

Well it seems that my [[{{< relref "20080806-yet-another-upgrade" >}}][upgrade]] of [[https://www.movabletype.com/][Movable Type]] didn't go as smoothly as I thought.
...
So, I'm now redesigning/rebuilding new templates ... so the site may not be too pretty for awhile.
