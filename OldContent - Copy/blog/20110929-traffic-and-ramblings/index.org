...
#+lastmod: 2011-09-29T19:35:00+12:00
#+categories[]: Teaching
#+tags[]: BUSINESS101
#+draft: False

There has been a little bump in traffic, so I've kicked off [[https://awstats.sourceforge.net/][AW Stats]] process to workout what/who//etc/ is happening.

Tick. Tock. Tick. Tock. Tick. Ding.

Okay, it looks like some of my current students have rumbled that this blog exists. That's a bit later in the course than usual, but not unexpected. Most are using computers at the [[https://web.archive.org/web/20110606044925/https://www.auckland.ac.nz/uoa/][University]], and a few are doing it from home. Looking at the logs, it's still a surprise to me, how late (or early) they're using their computers; but I guess I was the same when I was at their age. I recall pulling many all-nighters as I worked on various projects.
