...
#+lastmod: 2018-05-24T19:19:55+12:00
#+categories[]: Tech
#+tags[]: Ubiquiti Edgerouter
#+slug: uqbiquity-installation
#+draft: False

So I have faster [[{{< relref "20180521-faster-internet" >}}][Internet]]. How to take advantage of it?
...
In sorting out that problem, I came across the website [[https://canyouseeme.org/]]. Very useful for checking if a port is open on your external IP address.
