...
I've just opened the flood-gates [[{{< ref "opening-the-floodgates" >}}][again]] and sent out an email with the login details for Net Mike. One thing I'm [[{{< ref "mikes-bikes-message-board" >}}][interested]] in is the way in which people use the messaging board of Net Mike. I wonder how (or if) it will be used this time.
