...
#+lastmod: 2004-09-17T23:04:00+12:00
#+categories[]: Teaching
#+tags[]: MGMT301
#+draft: False
...
In the original [[https://plato.stanford.edu/entries/prisoner-dilemma/][prisoner's dilemma]] if there was only one change to sell bread then the 'best' thing either baker can do is drop their prices. However, if there are likely to be repeated rounds, then the baker should wait and see if the other baker drops their price.
...
As an aside, has anyone tried the [[https://www.algonet.se/~ug/projects/lightbulb/][100 prisoner's problem]]? I'm surprised this hasn't shown up in BCG interviews yet (or has it?).
