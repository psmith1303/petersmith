...
1. Write clearly and simply; don't write to sound clever.
2. Focus on explanatory language (explaining stuff) rather than declarative language (telling stuff).
3. If you have a problem in the third act, the real problem is in the second act (Billy Wilder).
