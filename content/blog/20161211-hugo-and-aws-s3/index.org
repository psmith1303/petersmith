...
#+lastmod: 2016-12-11T12:53:55+13:00
#+categories[]: Tech
#+tags[]: AWS S3
#+draft: False

This site, and a few others I have, are built using [[https://gohugo.io/][Hugo]]. Until today, I have been hosting the sites on a spare [[https://www.raspberrypi.org/][Raspberry Pi]] I had lying around at home. That is all well and good, but I think I want something more robust.
...
4. Change your DNS to point to the S3 bucket. Specifically, set a CNAME
   record to point to the S3 bucket. The bucket will have a name something like =petersmith.org.s3-website-us-west-2.amazonaws.com=.
...
3. Set a A record on the DNS to point to =174.129.25.170= at [[https://wwwizer.com/][wwwizer]]. It's not their main business but it works.
