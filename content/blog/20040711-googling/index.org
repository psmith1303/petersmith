...
draft = "False"
+++
I see that [Amit](https://www.thereflectivepractitioner.org/armi/) has
an
[interesting](https://www.thereflectivepractitioner.org/armi/archives/000383.html)
...
<https://www.thereflectivepractitioner.org/>
every day or so, it never crawls through the whole web site. It just
reads the
[robots.txt](https://www.thereflectivepractitioner.org/robots.txt) file
and the main index of [The
reflectivepractitioner](https://www.thereflectivepractitioner.org/) and
then stops. I can't figure out what's going-on.

The [robot exclusion file](https://www.robotstxt.org/wc/exclusion.html),
that is to say
[robots.txt](https://www.thereflectivepractitioner.org/robots.txt),
