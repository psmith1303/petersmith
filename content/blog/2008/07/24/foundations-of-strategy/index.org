...
As I've noted [[{{< ref "judgement" >}}][elsewhere]], [[{{< ref "judgement-2" >}}][here]], and a bit [[{{< ref "self-review-of-intbus-202" >}}][here]], For me, one of the consequential overarching themes, is good judgement. Thus, participants in the course need to practice their judgement--and get feedback on it--so as to refine it.
