...
I did a half-hearted port from [[{{< relref "20200721-markingdown-markdown" >}}][Markdown to Orgmode]] for the underlying text of this site. And I also did a half-hearted port to using [[{{< relref "20211215-images-and-page-bundles" >}}][Hugo page bundles]] (in anticipating of getting [[{{< relref "20211010-first-steps-to-indieweb" >}}][webmentions]] working).
