...
#+slug: bye-bye-synology
#+date: 2017-12-02T13:09:19+13:00
#+lastmod: 2017-12-02T13:09:19+13:00
#+categories[]: Tech
#+tags[]: Synology FreeNAS FreeBSD NAS Rsync
#+draft: False
...
I'm using a similar backing up system (off-site with =rsync=), but I also use =syncthing= to move date (in kind of real time) between the various systems I have at home and at work.
