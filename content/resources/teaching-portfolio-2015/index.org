...
{{< figure src="mgmt300-instructor.png" caption="Student evaluation of instructor" alt="SET report for MGMT 300" >}}

In addition, they were also satisfied with the quality of the course:

{{< figure src="mgmt300-course.png" caption="Student evaluation of course" alt="SET report for MGMT 300" >}}
...
{{< figure src="frustrating.png" caption="Student evaluation showing frustration" alt="Student expressing frustration" >}}
...
{{< figure src="304grades.png" caption="BUSINESS 304 grade trend" alt="A graph of grades in BUSINESS 304" >}}
